...
<div style="float:none;margin:0 auto" class="col-md-4">
    <form action="<?php echo ASSET_ROOT; ?>./home/goToView3/" method="post">
        ...
        houseNumber: <input type="text" name="houseNumber" class="form-control"
                            value='<?php echo $_SESSION['houseNumber']; ?>'><br>
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-danger" formaction="<?php echo ASSET_ROOT; ?>/home/goToView1/1"
                    formmethod="POST">Back
            </button>
